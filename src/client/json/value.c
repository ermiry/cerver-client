...
CLIENT_INLINE int json_object_set (
...
CLIENT_INLINE int json_object_set_nocheck (
...
CLIENT_INLINE int json_object_iter_set (
...
CLIENT_INLINE int json_object_update_new (
...
CLIENT_INLINE int json_object_update_existing_new (
	json_t *object, json_t *other
) {
...
CLIENT_INLINE int json_object_update_missing_new (
	json_t *object, json_t *other
) {
...
CLIENT_INLINE int json_array_set (
...
CLIENT_INLINE int json_array_append (
...
CLIENT_INLINE int json_array_insert (
	json_t *array, size_t ind, json_t *value
) {
