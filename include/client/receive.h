...
CLIENT_PUBLIC const char *receive_error_to_string (
...
CLIENT_PUBLIC const char *receive_type_to_string (
...
CLIENT_PUBLIC const char *receive_handle_state_to_string (
...
CLIENT_PRIVATE ReceiveHandle *receive_handle_new (void);

CLIENT_PRIVATE void receive_handle_delete (void *receive_ptr);
