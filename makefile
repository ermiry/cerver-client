...
DEFINES = -D CERVER_DEBUG -D CLIENT_DEBUG -D PACKETS_DEBUG
...
examples: ./examples/test.c ./examples/handlers.c ./examples/multi.c ./examples/requests.c ./examples/auth.c ./examples/sessions.c ./examples/admin.c
